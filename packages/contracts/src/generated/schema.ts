...
export interface components {
  schemas: {
    ...
    DashboardResponseDto: {
      banners: components['schemas']['DashboardSectionDto'];
      brands: components['schemas']['DashboardSectionDto'];
      categories: components['schemas']['DashboardSectionDto'];
      /** Format: date-time */
      generatedAt: string;
      news: components['schemas']['DashboardNewsDto'];
      products: components['schemas']['DashboardProductsDto'];
    };
    DashboardSectionDto: {
      active: number;
      total: number;
